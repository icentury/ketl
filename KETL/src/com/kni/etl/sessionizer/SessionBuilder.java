...
public class SessionBuilder implements Serializable
{
    ...
    public void setWaitQueueSize(BlockingQueue pWriterQueue)
    {
        ActiveSessionStore.initializeWaitQueue(pWriterQueue);
    }
     ...
     */
    public SessionBuilder(int pLoadID, int pdmLoadID, IDCounter pStartSessionID, BlockingQueue pWriterQueue)
    {
        super();

        this.setLoadIDs(pLoadID, pdmLoadID);

        ActiveSessionStore = new SessionStore(pStartSessionID, pWriterQueue);
     ...
     * PM)
     */
    public final BlockingQueue getDoneSessionsQueue()
    {
    ...
    {
        ActiveSessionStore.setSessionWriterThread(pSessionizationWriterRoot);
    }
