...
public class LookupWriter extends ETLWriter implements DefaultWriterCore, LookupCreatorImpl {
	...
	public class LookupWriterInPort extends ETLInPort {
		...
		public int initialize(Node xmlNode) throws ClassNotFoundException, KETLThreadException {
			...
			if (this.mKey != -1) {
				if (this.mKey < 1)
					throw new KETLThreadException("Port " + this.mesStep.getName() + "." + this.getPortName() + " KEY order starts at 1, invalid value of " + this.mKey, this);
				LookupWriter.this.mKeys++;
				this.mKey--;
			}
			if (this.mValue != -1) {
				if (this.mValue < 1)
					throw new KETLThreadException("Port " + this.mesStep.getName() + "." + this.getPortName() + " VALUE order starts at 1, invalid value of " + this.mValue, this);
