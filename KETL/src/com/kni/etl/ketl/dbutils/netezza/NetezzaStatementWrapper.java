...
final public class NetezzaStatementWrapper extends BulkLoaderStatementWrapper {
    ...
    private final Charset ENCODER = java.nio.charset.Charset.forName(ENCODING);
    ...
    public NetezzaStatementWrapper(Connection connection, String pTableName, String loadStatement,
        ...
        this.mLoadStatement = EngineConstants.replaceParameterV2(loadStatement, "BOOLSTYLE", BOOL_STYLE);
        this.mLoadStatement = EngineConstants.replaceParameterV2(mLoadStatement, "DATESTYLE", "YMD");
        this.mLoadStatement = EngineConstants.replaceParameterV2(mLoadStatement, "ENCODING", ENCODING);
        this.mLoadStatement = EngineConstants.replaceParameterV2(mLoadStatement, "ESCAPECHAR", ESCAPE_CHAR);
        this.mLoadStatement = EngineConstants.replaceParameterV2(mLoadStatement, "TIMESTYLE", "24HOUR");
        this.mLoadStatement = EngineConstants.replaceParameterV2(mLoadStatement, "NULLVALUE", NULL_VALUE);
        this.mLoadStatement = EngineConstants.replaceParameterV2(mLoadStatement, "LOGFILE", this.mControlFile + ".log");
        this.mLoadStatement = EngineConstants.replaceParameterV2(mLoadStatement, "BADFILE", this.mControlFile + ".bad");
        this.mLoadStatement = EngineConstants.replaceParameterV2(mLoadStatement, "CONTROLFILE", mControlFile);
    ...
    protected SQLException handleLoaderStatus(int finalStatus, Thread thread) throws InterruptedException {
        ...
        case EX_WARN:
            ResourcePool.LogMessage(Thread.currentThread(), ResourcePool.WARNING_MESSAGE,
                    "nzload reported a warning, check the log " + mControlFile + ".log");
            break;
        default:
            Thread.sleep(1000);
            if (filesOpen() == false) {
    ...
    public void setSQLDate(int pos, java.sql.Date arg0) {
        this.setObject(pos, this.sqlDateFormatter.format(arg0).getBytes(ENCODER));
    }

    public void setSQLTime(int pos, java.sql.Time arg0) {
        this.setObject(pos, this.sqlTimeFormatter.format(arg0).getBytes(ENCODER));
    }
    ...
    public void setTimestamp(int pos, Date arg0) {
        this.setObject(pos, this.sqlTimestampFormatter.format(arg0).getBytes(ENCODER));
    }
