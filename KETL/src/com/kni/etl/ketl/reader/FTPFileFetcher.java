...
public class FTPFileFetcher extends ETLReader implements DefaultReaderCore {
    ...
    class FTPWorkerThread extends Thread {
         ...
         * @param strTransferType the str transfer type
         * @param strFileName the str file name
         * @param strDestFileName the str dest file name
         * @param strPassiveMode the str passive mode
         * @param lExpectedSize the l expected size
         * @param lModifiedDate the l modified date
         * 
         * @return boolean
         */
    ...
    int getFilenamesForEachCompleteParameterList(int iParamList) {
        ...
        if ((strUser != null) && (strPassword != null) && (strServer != null) && (strPath != null)
            ...
            Object[] files = null;
            files = this.getFilenamesFromFTPServer(strUser, strPassword, strServer, strDestinationPath, binaryTransfer,
                    strPath, passiveMode);
            ...
            for (Object element : files) {
                ...
                if (((Object[]) element)[FTPFileFetcher.IGNOREFILE_POS] == null) {
                    ...
                    ResourcePool.LogMessage("Ignoring file " + ((Object[]) element)[FTPFileFetcher.FILENAME_POS]
     ...
     * @param strPassword the str password
     * @param strServer the str server
     * @param strDestinationPath the str destination path
     * @param bBinaryTransfer the b binary transfer
     * @param searchString the search string
     * @param bPassiveMode the b passive mode
     * 
    ...
    public Object[] getFilenamesFromFTPServer(String strUser, String strPassword, String strServer,
        ...
        Object[] result = null;
        FTPClient ftp = this.getFTPConnection(strUser, strPassword, strServer, bBinaryTransfer,
                ...
                if ((((String) cmpFileDetails[FTPFileFetcher.SERVER_POS]).compareTo((String) fileDetails[FTPFileFetcher.SERVER_POS]) == 0)
                    ...
                    ResourcePool.LogMessage(this, ResourcePool.WARNING_MESSAGE,
                            "Parameter list results in duplicate file search,"
                                    ...
                                    + (String) fileDetails[FTPFileFetcher.FILENAME_POS]);
                    alreadyListed = true;
                }
            }
    ...
    public int getNextRecord(Object[] pResultArray, Class[] pExpectedDataTypes, int pRecordWidth)
        ...
        while (((this.filesToDownload != null) && (this.filesToDownload.size() != 0))
                && (this.ftpThreadPool.size() <= this.iMaxParallelConnections)) {
