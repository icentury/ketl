...
abstract public class BulkLoaderStatementWrapper extends StatementWrapper {
    ...
    class LoaderProcess extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                ResourcePool.LogException(new KETLWriteException("STDERROR:" + getStandardErrorMessage() + "\nSTDOUT:"
    ...
    abstract public void setBoolean(int pos, boolean arg0);

    abstract public void setByteArrayValue(int pos, byte[] arg0);

    abstract public void setDouble(int pos, Double arg0);

    abstract public void setFloat(int pos, Float arg0);

    abstract public void setInt(int pos, Integer arg0);

    abstract public void setLong(int pos, Long arg0);

    abstract public void setNull(int pos, int dataType);

    abstract public void setObject(int pos, byte[] arg0);
    ...
    abstract public void setShort(int pos, Short arg0);
    ...
    abstract public void setString(int pos, String arg0);

    abstract public void setTimestamp(int pos, Date arg0);
