...
* Creation date: (4/19/2002 5:47:07 PM)
...
public class KNIHashMap extends AbstractMap implements Map, Cloneable, java.io.Serializable
{
    ...
    /**
     * Returns a shallow copy of this <tt>KNIHashMap</tt> instance: the keys and
     ...
     *               also indicate that the KNIHashMap previously associated
    ...
    /**
     * Reconstitute the <tt>KNIHashMap</tt> instance from a stream (i.e.,
     * deserialize it).
     */
    ...
    /**
     * Rehashes the contents of this map into a new <tt>KNIHashMap</tt> instance
    ...
    /**
     * Save the state of the <tt>KNIHashMap</tt> instance to a stream (i.e.,
     * serialize it).
     *
     * @serialData The <i>capacity</i> of the KNIHashMap (the length of the
     *                   bucket array) is emitted (int), followed  by the
     *                   <i>size</i> of the KNIHashMap (the number of key-value
     *                   mappings), followed by the key (Object) and value (Object)
     *                   for each key-value mapping represented by the KNIHashMap
