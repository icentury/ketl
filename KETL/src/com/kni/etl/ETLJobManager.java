 ...
 * Creation date: (5/1/2002 4:53:44 PM)
...
public class ETLJobManager
{
    ...
    public ETLJobManager(String strJobExecutorClass, int iMaxNumThreads, int iMaxQueueSize)
    {
        ...
        mjmsStatus.setStatusCode(ETLJobManagerStatus.INITIALIZING); // We'll set this to READY once we have a thread available
     ...
     * Creation date: (5/3/2002 4:59:38 PM)
     * @return boolean
     ...
     * Creation date: (5/7/2002 10:30:20 AM)
    ...
    /**
     * Insert the method's description here.
     * Creation date: (5/3/2002 3:01:31 PM)
     * @return int
     */
    ...
    /**
     * Insert the method's description here.
     * Creation date: (5/7/2002 9:35:25 AM)
     * @return int
     */
    ...
    /**
     * Insert the method's description here.
     * Creation date: (5/8/2002 5:43:10 PM)
     */
    ...
    /**
     * Insert the method's description here.
     * Creation date: (5/8/2002 6:02:15 PM)
     * @return int
     */
    ...
    /**
     * Insert the method's description here.
     * Creation date: (5/7/2002 9:39:00 AM)
     * @return int
     */
    ...
    /**
     * Do not keep a reference to this status object if you are not running the manager in a different thread...
     * ...you will need to run updateStatus() to refresh the status.
    ...
    /**
     * Note that this will not affect jobs currently in the queue.  It is meant to create a new limit.
     * Creation date: (5/7/2002 9:39:00 AM)
    ...
    /**
     * Insert the method's description here.
     * Creation date: (5/9/2002 10:09:11 AM)
     * @return boolean
     */
    ...
    /**
     * Insert the method's description here.
     * Creation date: (5/4/2002 8:06:24 PM)
    ...
    /**
     * Insert the method's description here.
     * Creation date: (5/3/2002 2:58:47 PM)
     * @return boolean
    ...
    public int updateStatus()
    {
        ...
        synchronized (mllPendingQueue)
        {
            ...
            if ((aiNumThreadsAtStatus == null) && (iNumThreads > 0))
            {
                ResourcePool.LogMessage(this,
                        ResourcePool.WARNING_MESSAGE,"No status array, but there are still threads in the collection...");
                aiNumThreadsAtStatus = checkExecutorThreads();
            }
        ...
        // Check for special states TERMINATED, SHUTTING_DOWN or ERROR, since they are computed differently than the others...
        ...
        // Now, perform the logic to determine our status (we have already taken the trouble states out of the way to make
        ...
        mjmsStatus.setWarningMessage(
            "Unexpected state derived when checking job and executor status.  Temporarily setting to FULL.");
