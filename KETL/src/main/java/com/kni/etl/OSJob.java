...
public class OSJob extends ETLJob {
  ...
  private String msWriteBackParameter;

  private String msWriteBackParameterList;
  ...
  /**
   * Currently REMOVED from exposure, since Java is inconsistent (pre 1.4) with working directories
   * Creation date: (5/7/2002 2:34:14 PM)
   * 
   * @param strCommandLine java.lang.String
  ...
  public java.lang.String getCommandLine() throws Exception {
    ...
    if (cmd.indexOf("<OSJOB") != -1) {
      ...
      this.msWriteBackParameter =
          XMLHelper.getAttributeAsString(nl.item(0).getAttributes(), ETLJob.WRITEBACK_PARAMETER,
              null);
      this.msWriteBackParameterList =
          XMLHelper.getAttributeAsString(nl.item(0).getAttributes(),
  ...
  public boolean hasWritebackParameter() {
    return msWriteBackParameter != null;
  }

  public String getWritebackParameterName() {
    return this.msWriteBackParameter;
  }

  public String getWritebackParameterListName() {
    return this.msWriteBackParameterList;
  }
