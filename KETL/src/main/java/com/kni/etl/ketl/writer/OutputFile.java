...
public class OutputFile {
	...
	public String open(File file) throws IOException {
		...
		CharsetEncoder charSet = (mCharSet == null ? java.nio.charset.Charset.defaultCharset()
				.newEncoder() : java.nio.charset.Charset.forName(mCharSet).newEncoder());

		ResourcePool.LogMessage(Thread.currentThread(), ResourcePool.INFO_MESSAGE, "Writing to file " + file.getAbsolutePath()
