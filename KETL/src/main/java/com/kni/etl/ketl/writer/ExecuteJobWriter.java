...
public class ExecuteJobWriter extends ETLWriter implements DefaultWriterCore {
	 ...
	 */
	public ExecuteJobWriter(Node pXMLConfig, int pPartitionID, int pPartition, ETLThreadManager pThreadManager) throws KETLThreadException {
	...
	public int putNextRecord(Object[] pInputRecords, Class[] pExpectedDataTypes, int pRecordWidth) throws KETLWriteException {
		...
		if (o != null)
			o = this.mInPorts[(Integer) o].isConstant() ? this.mInPorts[(Integer) o].getConstantValue() : pInputRecords[this.mInPorts[(Integer) o].getSourcePortIndex()];
	...
	public int initialize(Node pXmlConfig) throws KETLThreadException {
		...
		java.util.Collections.addAll(hs, new Object[] { "JOB_ID", "PROJECT_ID", "IGNOREDEPENDENCIES", "ALLOWMULTIPLE" });
