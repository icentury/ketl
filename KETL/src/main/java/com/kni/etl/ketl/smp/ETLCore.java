...
abstract public class ETLCore implements DefaultCore {
	...
	public ETLWorker getOwner() {
		return (ETLWorker) this.ownerStep;
	}
	 ...
	 */
	final protected Object lookupD(String pLookupName, Object pKey1, String pField, Object defaultValue) throws InterruptedException,
			KETLThreadException {
	 ...
	 *             the KETL thread exception
	 */
	final protected Object lookup(String pLookupName, Object pKey1, String pField) throws InterruptedException, KETLThreadException {
	 ...
	 *             the KETL thread exception
	 */
	final protected Object lookup(String pLookupName, Object pKey1, Object pKey2, String pField) throws InterruptedException,
			KETLThreadException {
		PersistentMap mp = this.getLookup(pLookupName);
		if (pField == null)
	 ...
	 *             the KETL thread exception
	 */
	final protected Object lookup(String pLookupName, Object pKey1, Object pKey2, Object pKey3, String pField) throws InterruptedException,
			KETLThreadException {
		PersistentMap mp = this.getLookup(pLookupName);
		if (pField == null)
	 ...
	 *             the KETL thread exception
	 */
	final protected Object lookup(String pLookupName, Object pKey1, Object pKey2, Object pKey3, Object pKey4, String pField)
	...
	final private PersistentMap getLookup(String pLookupName) throws InterruptedException, KETLThreadException {
		...
		if (res == null) {
			res = ((KETLJob) ((ETLStep) this.getOwner()).getJobExecutor().getCurrentETLJob()).getSharedLookup(pLookupName, this);
	 ...
	 *             the KETL thread exception
	 */
	final protected Object scdLookup(String pLookupName, Object pKey1, java.util.Date pEffectiveDate) throws InterruptedException,
			KETLThreadException {
		PersistentMap mp = this.getLookup(pLookupName);
	 ...
	 *             the KETL thread exception
	 */
	final protected Object scdLookup(String pLookupName, Object pKey1, Object pKey2, Object pKey3, java.util.Date pEffectiveDate)
			throws InterruptedException, KETLThreadException {
		PersistentMap mp = this.getLookup(pLookupName);
	...
	final protected Object scdLookup(String pLookupName, Object pKey1, Object pKey2, Object pKey3, Object pKey4,
		...
		PersistentMap mp = this.getLookup(pLookupName);
		return SCDValue.getNearestSCDValue((SCDValue) mp.get(new Object[] { pKey1, pKey2, pKey3, pKey4 }), pEffectiveDate);
