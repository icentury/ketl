...
abstract public class ETLCore implements DefaultCore {
   ...
   */
  final protected Object lookupD(String pLookupName, Object pKey1, String pField,
      Object defaultValue) throws InterruptedException, KETLThreadException {
  ...
  final protected Object sendEmail(String subject, String text) {
    ...
    try {
      ...
      md.sendEmail(((ETLStep) this.ownerStep).getJobExecutor().getCurrentETLJob().getJobID(),
          subject, text);
      return true;
    } catch (Exception e) {
   ...
   * @throws KETLThreadException the KETL thread exception
   */
  final protected Object lookup(String pLookupName, Object pKey1, String pField)
   ...
   * @throws KETLThreadException the KETL thread exception
   */
  final protected Object lookup(String pLookupName, Object pKey1, Object pKey2, Object pKey3,
   ...
   */
  final protected Object lookup(String pLookupName, Object pKey1, Object pKey2, Object pKey3,
      Object pKey4, String pField) throws InterruptedException, KETLThreadException {
    PersistentMap mp = this.getLookup(pLookupName);
    if (pField == null)
  ...
  /** The local lookups. */
  private final HashMap mLocalLookups = new HashMap();
   ...
   * @throws KETLThreadException the KETL thread exception
   */
  final private PersistentMap getLookup(String pLookupName) throws InterruptedException,
      KETLThreadException {
    ...
    if (res == null) {
      res =
          ((KETLJob) ((ETLStep) this.getOwner()).getJobExecutor().getCurrentETLJob())
              .getSharedLookup(pLookupName, this);
   ...
   */
  protected final static java.util.Date toDate(String arg0, String arg1, String format)
   ...
   * @throws KETLThreadException the KETL thread exception
   */
  final protected Object scdLookup(String pLookupName, Object pKey1, Object pKey2,
      java.util.Date pEffectiveDate) throws InterruptedException, KETLThreadException {
    PersistentMap mp = this.getLookup(pLookupName);
    return SCDValue.getNearestSCDValue((SCDValue) mp.get(new Object[] {pKey1, pKey2}),
        pEffectiveDate);
  ...
  final protected Object scdLookup(String pLookupName, Object pKey1, Object pKey2, Object pKey3,
      java.util.Date pEffectiveDate) throws InterruptedException, KETLThreadException {
    PersistentMap mp = this.getLookup(pLookupName);
    return SCDValue.getNearestSCDValue((SCDValue) mp.get(new Object[] {pKey1, pKey2, pKey3}),
        pEffectiveDate);
   ...
   */
  final protected Object scdLookup(String pLookupName, Object pKey1, Object pKey2, Object pKey3,
      Object pKey4, java.util.Date pEffectiveDate) throws InterruptedException, KETLThreadException {
    PersistentMap mp = this.getLookup(pLookupName);
    return SCDValue.getNearestSCDValue(
        (SCDValue) mp.get(new Object[] {pKey1, pKey2, pKey3, pKey4}), pEffectiveDate);
