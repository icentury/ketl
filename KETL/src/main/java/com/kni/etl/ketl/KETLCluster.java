...
public class KETLCluster {
  ...
  public class Server {
     ...
     */
    public Server(int mServerID, String mName, Timestamp mStarted, Timestamp mLastPing,
        String mStatus, Timestamp mSystemTime) {
      super();
  ...
  public String[] getServerList() {
    ...
    while (iter.hasNext()) {
      ...
      ls.add("ID: " + s.mServerID + ", Name: " + s.mName + ", Status: " + s.mStatus
          + ", Last Ping: " + s.mLastPing);
    }
   ...
   * @param mSystemTime The system time
   */
  public void addServer(int mServerID, String mName, Timestamp mStarted, Timestamp mLastPing,
      String mStatus, Timestamp mSystemTime) {
  ...
  public Server newServer(int mServerID, String mName, Timestamp mStarted, Timestamp mLastPing,
      String mStatus, Timestamp mSystemTime) {
