...
final public class RedshiftCopyFileWriter {
  ...
  public RedshiftCopyFileWriter(String[] cols, Connection con, File spoolDir, String awsKey,
      String secretKey, String bucketName, String parentDir, String charsetName, boolean zip,
      int bufferSize, int rowLimit) throws IOException {
    super();
  ...
  private void createOutputFile() throws IOException {
    this.mFileRows = 0;
    this.outputFile =
        new S3OutputFile(awsKey, secretKey, bucketName, parentDir, charsetName, zip, bufferSize);
    if (!spoolDir.exists())
      spoolDir.mkdir();
